 ...
 * @module
 */
import { ReconnectingWebSocket, type ReconnectingWebSocketOptions } from "../../deps/jsr.io/@nktkas/rews/4.1.0/mod.js";
...
import { type WebSocketKeepAliveOptions } from "./_keepAlive.js";
 ...
 */
export declare class WebSocketTransport implements IRequestTransport<"info" | "exchange">, ISubscriptionTransport {
    /** Indicates this transport uses testnet endpoint. */
