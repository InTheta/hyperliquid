 ...
 * ```
 */
export declare function signL1Action<TAction extends Record<string, unknown> | unknown[]>(args: {
 ...
 * @throws {AbstractWalletError} If signing fails.
 */
export declare function signL1Inner(args: {
