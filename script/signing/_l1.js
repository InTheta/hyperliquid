...
exports.signL1Inner = signL1Inner;
...
const _multiSig_js_1 = require("./_multiSig.js");
/**
...
function createL1ActionHash(args) {
    ...
    const actionBytes = (0, encode_js_1.encode)(adjust(action));
    ...
    return `0x${(0, utils_js_1.bytesToHex)((0, sha3_js_1.keccak_256)(bytes))}`;
}
/**
...
async function signL1Inner(args) {
    ...
    return (0, _multiSig_js_1.trimSignature)(signature);
}
//# sourceMappingURL=_l1.js.map