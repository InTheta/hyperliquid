...
function adapt(wallet) {
    if (isViemJsonRpc(wallet))
        return adaptViemJsonRpc(wallet);
    if (isViemLocal(wallet))
        return adaptViemLocal(wallet);
    if (isEthersV6Signer(wallet))
        return adaptEthersV6(wallet);
    if (isEthersV5Signer(wallet))
        return adaptEthersV5(wallet);
