 ...
 * @see null
 */
export declare function txDetails(config: ExplorerConfig<IRequestTransport<"explorer">>, params: TxDetailsParameters, signal?: AbortSignal): Promise<TxDetailsResponse>;
