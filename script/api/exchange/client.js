...
const agentSendAsset_js_1 = require("./_methods/agentSendAsset.js");
...
const authorizeAqav2Role_js_1 = require("./_methods/authorizeAqav2Role.js");
...
const finalizeEvmContract_js_1 = require("./_methods/finalizeEvmContract.js");
const gossipPriorityBid_js_1 = require("./_methods/gossipPriorityBid.js");
const hip3LiquidatorTransfer_js_1 = require("./_methods/hip3LiquidatorTransfer.js");
...
const stakingLinkDisableTradingUser_js_1 = require("./_methods/stakingLinkDisableTradingUser.js");
...
const userOutcome_js_1 = require("./_methods/userOutcome.js");
...
class ExchangeClient {
    ...
    agentSendAsset(params, opts) {
        return (0, agentSendAsset_js_1.agentSendAsset)(this.config_, params, opts);
    }
    /**
    ...
    authorizeAqav2Role(params, opts) {
        return (0, authorizeAqav2Role_js_1.authorizeAqav2Role)(this.config_, params, opts);
    }
    /**
    ...
    finalizeEvmContract(params, opts) {
        return (0, finalizeEvmContract_js_1.finalizeEvmContract)(this.config_, params, opts);
    }
    /**
    ...
    gossipPriorityBid(params, opts) {
        return (0, gossipPriorityBid_js_1.gossipPriorityBid)(this.config_, params, opts);
    }
    /**
    ...
    hip3LiquidatorTransfer(params, opts) {
        return (0, hip3LiquidatorTransfer_js_1.hip3LiquidatorTransfer)(this.config_, params, opts);
    }
    /**
     ...
     */
    noop(params, opts) {
        return (0, noop_js_1.noop)(this.config_, params, opts);
    }
    /**
    ...
    stakingLinkDisableTradingUser(params, opts) {
        return (0, stakingLinkDisableTradingUser_js_1.stakingLinkDisableTradingUser)(this.config_, params, opts);
    }
    /**
    ...
    userOutcome(params, opts) {
        return (0, userOutcome_js_1.userOutcome)(this.config_, params, opts);
    }
    /**
