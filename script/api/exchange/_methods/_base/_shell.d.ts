 ...
 */
export declare function executeWithShell<T>(config: ExchangeConfig, build: (nonce: number) => Promise<BuildResult>, signal?: AbortSignal): Promise<T>;
//# sourceMappingURL=_shell.d.ts.map