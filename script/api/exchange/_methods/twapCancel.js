...
const TwapCancelActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.TwapCancelRequest.entries.action.entries);
})();
/**
 * Cancel a TWAP order.
 *
...
function twapCancel(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(TwapCancelActionSchema, (0, _base_js_1.parse)(TwapCancelActionSchema, { type: "twapCancel", ...params }));
