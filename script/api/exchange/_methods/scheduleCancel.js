...
const ScheduleCancelActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.ScheduleCancelRequest.entries.action.entries);
})();
function scheduleCancel(config, paramsOrOpts, maybeOpts) {
    ...
    const action = (0, mod_js_1.canonicalize)(ScheduleCancelActionSchema, (0, _base_js_1.parse)(ScheduleCancelActionSchema, { type: "scheduleCancel", ...params }));
