...
const TwapOrderActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.TwapOrderRequest.entries.action.entries);
})();
/**
 * Place a TWAP order.
 *
...
function twapOrder(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(TwapOrderActionSchema, (0, _base_js_1.parse)(TwapOrderActionSchema, { type: "twapOrder", ...params }));
