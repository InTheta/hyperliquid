...
function agentSetAbstraction(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(AgentSetAbstractionActionSchema, (0, _base_js_1.parse)(AgentSetAbstractionActionSchema, { type: "agentSetAbstraction", ...params }));
