...
function sendToEvmWithData(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SendToEvmWithDataActionSchema, (0, _base_js_1.parse)(SendToEvmWithDataActionSchema, { type: "sendToEvmWithData", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.SendToEvmWithDataTypes, opts);
}
