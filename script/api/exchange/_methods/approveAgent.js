...
function approveAgent(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(ApproveAgentActionSchema, (0, _base_js_1.parse)(ApproveAgentActionSchema, { type: "approveAgent", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.ApproveAgentTypes, opts);
}
