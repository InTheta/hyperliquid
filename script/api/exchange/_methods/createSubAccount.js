...
const CreateSubAccountActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.CreateSubAccountRequest.entries.action.entries);
})();
/**
 * Create a sub-account.
 *
...
function createSubAccount(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(CreateSubAccountActionSchema, (0, _base_js_1.parse)(CreateSubAccountActionSchema, { type: "createSubAccount", ...params }));
