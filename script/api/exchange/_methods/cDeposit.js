...
const CDepositActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.CDepositRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function cDeposit(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(CDepositActionSchema, (0, _base_js_1.parse)(CDepositActionSchema, { type: "cDeposit", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.CDepositTypes, opts);
}
