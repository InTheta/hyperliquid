...
const TokenDelegateActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.TokenDelegateRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function tokenDelegate(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(TokenDelegateActionSchema, (0, _base_js_1.parse)(TokenDelegateActionSchema, { type: "tokenDelegate", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.TokenDelegateTypes, opts);
}
