...
const SubAccountSpotTransferActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.SubAccountSpotTransferRequest.entries.action.entries);
})();
/**
 * Transfer between sub-accounts (spot).
 *
...
function subAccountSpotTransfer(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SubAccountSpotTransferActionSchema, (0, _base_js_1.parse)(SubAccountSpotTransferActionSchema, { type: "subAccountSpotTransfer", ...params }));
