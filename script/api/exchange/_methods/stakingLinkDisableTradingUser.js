...
exports.StakingLinkDisableTradingUserTypes = exports.StakingLinkDisableTradingUserRequest = void 0;
exports.stakingLinkDisableTradingUser = stakingLinkDisableTradingUser;
 ...
 */
exports.StakingLinkDisableTradingUserRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
            ...
            tradingUser: _schemas_js_1.Address,
...
const StakingLinkDisableTradingUserActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.StakingLinkDisableTradingUserRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
/** EIP-712 types for the {@linkcode stakingLinkDisableTradingUser} function. */
exports.StakingLinkDisableTradingUserTypes = {
...
function stakingLinkDisableTradingUser(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(StakingLinkDisableTradingUserActionSchema, (0, _base_js_1.parse)(StakingLinkDisableTradingUserActionSchema, { type: "stakingLinkDisableTradingUser", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.StakingLinkDisableTradingUserTypes, opts);
}
//# sourceMappingURL=stakingLinkDisableTradingUser.js.map