...
const UsdSendActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UsdSendRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "time"]);
})();
...
function usdSend(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(UsdSendActionSchema, (0, _base_js_1.parse)(UsdSendActionSchema, { type: "usdSend", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.UsdSendTypes, opts);
}
