...
function convertToMultiSigUser(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(ConvertToMultiSigUserActionSchema, (0, _base_js_1.parse)(ConvertToMultiSigUserActionSchema, { type: "convertToMultiSigUser", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.ConvertToMultiSigUserTypes, opts);
}
