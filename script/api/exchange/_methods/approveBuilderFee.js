...
function approveBuilderFee(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(ApproveBuilderFeeActionSchema, (0, _base_js_1.parse)(ApproveBuilderFeeActionSchema, { type: "approveBuilderFee", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.ApproveBuilderFeeTypes, opts);
}
