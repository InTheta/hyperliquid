...
const ReserveRequestWeightActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.ReserveRequestWeightRequest.entries.action.entries);
})();
/**
 * Reserve additional rate-limited actions for a fee.
 *
...
function reserveRequestWeight(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(ReserveRequestWeightActionSchema, (0, _base_js_1.parse)(ReserveRequestWeightActionSchema, { type: "reserveRequestWeight", ...params }));
