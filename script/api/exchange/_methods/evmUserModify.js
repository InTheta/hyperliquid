...
const EvmUserModifyActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.EvmUserModifyRequest.entries.action.entries);
})();
/**
 * Configure block type for EVM transactions.
 *
...
function evmUserModify(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(EvmUserModifyActionSchema, (0, _base_js_1.parse)(EvmUserModifyActionSchema, { type: "evmUserModify", ...params }));
