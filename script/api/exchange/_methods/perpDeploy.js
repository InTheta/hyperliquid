                ...
                insertMarginTable: v.object({
                    ...
                    marginTable: v.object({
                        ...
                        marginTiers: v.pipe(v.array(v.object({
                            ...
                            lowerBound: _schemas_js_1.UnsignedInteger,
                            /** Maximum leverage (between `1` and `50`). */
                            maxLeverage: v.pipe(_schemas_js_1.UnsignedInteger, v.minValue(1), v.maxValue(50)),
                        })), v.maxLength(3)),
                    }),
                }),
            }),
...
function perpDeploy(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(PerpDeployActionSchema, (0, _base_js_1.parse)(PerpDeployActionSchema, { type: "perpDeploy", ...params }));
