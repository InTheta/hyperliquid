...
function withdraw3(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(Withdraw3ActionSchema, (0, _base_js_1.parse)(Withdraw3ActionSchema, { type: "withdraw3", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.Withdraw3Types, opts);
}
