        ...
        action: v.variant("type", [
            ...
            v.object({
                ...
                requestEvmContract: v.object({
                     ...
                     */
                    evmExtraWeiDecimals: v.pipe(_schemas_js_1.Integer, v.minValue(-2), v.maxValue(18)),
                }),
            }),
        ]),
...
function spotDeploy(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SpotDeployActionSchema, (0, _base_js_1.parse)(SpotDeployActionSchema, { type: "spotDeploy", ...params }));
