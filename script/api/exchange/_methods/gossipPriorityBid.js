...
exports.GossipPriorityBidRequest = void 0;
exports.gossipPriorityBid = gossipPriorityBid;
 ...
 */
exports.GossipPriorityBidRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
            ...
            slotId: v.pipe(_schemas_js_1.UnsignedInteger, v.maxValue(1)),
...
const GossipPriorityBidActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.GossipPriorityBidRequest.entries.action.entries);
})();
/**
 * Bid in a gossip priority Dutch auction to receive prioritized mempool data for an IP.
 *
...
function gossipPriorityBid(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(GossipPriorityBidActionSchema, (0, _base_js_1.parse)(GossipPriorityBidActionSchema, { type: "gossipPriorityBid", ...params }));
    return (0, mod_js_2.executeL1Action)(config, action, opts);
}
//# sourceMappingURL=gossipPriorityBid.js.map