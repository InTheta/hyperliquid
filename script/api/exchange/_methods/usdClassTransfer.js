...
const UsdClassTransferActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UsdClassTransferRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function usdClassTransfer(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(UsdClassTransferActionSchema, (0, _base_js_1.parse)(UsdClassTransferActionSchema, { type: "usdClassTransfer", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.UsdClassTransferTypes, opts);
}
