...
const SubAccountModifyActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.SubAccountModifyRequest.entries.action.entries);
})();
/**
 * Modify a sub-account.
 *
...
function subAccountModify(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SubAccountModifyActionSchema, (0, _base_js_1.parse)(SubAccountModifyActionSchema, { type: "subAccountModify", ...params }));
