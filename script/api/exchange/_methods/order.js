        ...
        action: v.object({
            ...
            grouping: v.optional(v.union([
                ...
                v.object({
                    ...
                    p: v.pipe(_schemas_js_1.UnsignedInteger, v.maxValue(80000)),
                }),
            ]), "na"),
            /** Builder fee. */
...
const OrderActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.OrderRequest.entries.action.entries);
})();
/**
 * Place an order(s).
 *
...
function order(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(OrderActionSchema, (0, _base_js_1.parse)(OrderActionSchema, { type: "order", ...params }));
