...
const UserDexAbstractionActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UserDexAbstractionRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function userDexAbstraction(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(UserDexAbstractionActionSchema, (0, _base_js_1.parse)(UserDexAbstractionActionSchema, { type: "userDexAbstraction", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.UserDexAbstractionTypes, opts);
}
