...
const CancelActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.CancelRequest.entries.action.entries);
})();
/**
 * Cancel order(s).
 *
...
function cancel(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(CancelActionSchema, (0, _base_js_1.parse)(CancelActionSchema, { type: "cancel", ...params }));
