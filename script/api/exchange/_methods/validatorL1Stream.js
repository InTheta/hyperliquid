...
const ValidatorL1StreamActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.ValidatorL1StreamRequest.entries.action.entries);
})();
/**
 * Validator vote on risk-free rate for aligned quote asset.
 *
...
function validatorL1Stream(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(ValidatorL1StreamActionSchema, (0, _base_js_1.parse)(ValidatorL1StreamActionSchema, { type: "validatorL1Stream", ...params }));
