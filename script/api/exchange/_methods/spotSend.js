...
const SpotSendActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.SpotSendRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "time"]);
})();
...
function spotSend(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SpotSendActionSchema, (0, _base_js_1.parse)(SpotSendActionSchema, { type: "spotSend", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.SpotSendTypes, opts);
}
