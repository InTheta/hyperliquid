...
const SpotUserActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.SpotUserRequest.entries.action.entries);
})();
/**
 * Opt Out of Spot Dusting.
 *
...
function spotUser(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SpotUserActionSchema, (0, _base_js_1.parse)(SpotUserActionSchema, { type: "spotUser", ...params }));
