...
const VaultTransferActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.VaultTransferRequest.entries.action.entries);
})();
/**
 * Deposit or withdraw from a vault.
 *
...
function vaultTransfer(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(VaultTransferActionSchema, (0, _base_js_1.parse)(VaultTransferActionSchema, { type: "vaultTransfer", ...params }));
