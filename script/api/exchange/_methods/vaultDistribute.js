...
const VaultDistributeActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.VaultDistributeRequest.entries.action.entries);
})();
/**
 * Distribute funds from a vault between followers.
 *
...
function vaultDistribute(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(VaultDistributeActionSchema, (0, _base_js_1.parse)(VaultDistributeActionSchema, { type: "vaultDistribute", ...params }));
