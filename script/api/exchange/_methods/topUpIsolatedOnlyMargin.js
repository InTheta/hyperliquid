...
const TopUpIsolatedOnlyMarginActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.TopUpIsolatedOnlyMarginRequest.entries.action.entries);
})();
/**
 * Top up isolated margin by targeting a specific leverage.
 *
...
function topUpIsolatedOnlyMargin(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(TopUpIsolatedOnlyMarginActionSchema, (0, _base_js_1.parse)(TopUpIsolatedOnlyMarginActionSchema, { type: "topUpIsolatedOnlyMargin", ...params }));
