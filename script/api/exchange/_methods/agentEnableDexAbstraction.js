...
const AgentEnableDexAbstractionActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.AgentEnableDexAbstractionRequest.entries.action.entries);
})();
/**
 * Enable HIP-3 DEX abstraction.
 *
...
function agentEnableDexAbstraction(config, opts) {
    const action = (0, mod_js_1.canonicalize)(AgentEnableDexAbstractionActionSchema, (0, _base_js_1.parse)(AgentEnableDexAbstractionActionSchema, { type: "agentEnableDexAbstraction" }));
