...
const SetReferrerActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.SetReferrerRequest.entries.action.entries);
})();
/**
 * Set a referral code.
 *
...
function setReferrer(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SetReferrerActionSchema, (0, _base_js_1.parse)(SetReferrerActionSchema, { type: "setReferrer", ...params }));
