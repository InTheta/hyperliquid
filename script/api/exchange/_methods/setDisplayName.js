...
const SetDisplayNameActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.SetDisplayNameRequest.entries.action.entries);
})();
/**
 * Set the display name in the leaderboard.
 *
...
function setDisplayName(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SetDisplayNameActionSchema, (0, _base_js_1.parse)(SetDisplayNameActionSchema, { type: "setDisplayName", ...params }));
