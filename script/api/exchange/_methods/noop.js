...
const NoopActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.NoopRequest.entries.action.entries);
})();
/**
 * This action does not do anything (no operation), but causes the nonce to be marked as used.
 *
...
function noop(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(NoopActionSchema, (0, _base_js_1.parse)(NoopActionSchema, { type: "noop" }));
    return (0, mod_js_2.executeL1Action)({ ...config, nonceManager: () => params.nonce }, action, opts);
}
