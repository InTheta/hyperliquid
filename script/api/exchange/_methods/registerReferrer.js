...
const RegisterReferrerActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.RegisterReferrerRequest.entries.action.entries);
})();
/**
 * Create a referral code.
 *
...
function registerReferrer(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(RegisterReferrerActionSchema, (0, _base_js_1.parse)(RegisterReferrerActionSchema, { type: "registerReferrer", ...params }));
