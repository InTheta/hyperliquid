...
exports.AuthorizeAqav2RoleRequest = void 0;
exports.authorizeAqav2Role = authorizeAqav2Role;
 ...
 */
exports.AuthorizeAqav2RoleRequest = (() => {
    return v.object({
        /** Action to perform. */
        action: v.object({
            /** Type of action. */
...
const AuthorizeAqav2RoleActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.AuthorizeAqav2RoleRequest.entries.action.entries);
})();
/**
 * Authorize an AQAv2 role.
 *
...
function authorizeAqav2Role(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(AuthorizeAqav2RoleActionSchema, (0, _base_js_1.parse)(AuthorizeAqav2RoleActionSchema, { type: "authorizeAqav2Role", ...params }));
    return (0, mod_js_2.executeL1Action)(config, action, opts);
}
//# sourceMappingURL=authorizeAqav2Role.js.map