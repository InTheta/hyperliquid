...
const CWithdrawActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.CWithdrawRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function cWithdraw(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(CWithdrawActionSchema, (0, _base_js_1.parse)(CWithdrawActionSchema, { type: "cWithdraw", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.CWithdrawTypes, opts);
}
