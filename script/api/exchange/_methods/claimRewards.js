...
const ClaimRewardsActionSchema = /* @__PURE__ */ (() => {
    return v.object(exports.ClaimRewardsRequest.entries.action.entries);
})();
/**
 * Claim rewards from referral program.
 *
...
function claimRewards(config, opts) {
    const action = (0, mod_js_1.canonicalize)(ClaimRewardsActionSchema, (0, _base_js_1.parse)(ClaimRewardsActionSchema, { type: "claimRewards" }));
