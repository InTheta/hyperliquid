...
const UserPortfolioMarginActionSchema = /* @__PURE__ */ (() => {
    return v.omit(v.object(exports.UserPortfolioMarginRequest.entries.action.entries), ["signatureChainId", "hyperliquidChain", "nonce"]);
})();
...
function userPortfolioMargin(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(UserPortfolioMarginActionSchema, (0, _base_js_1.parse)(UserPortfolioMarginActionSchema, { type: "userPortfolioMargin", ...params }));
    return (0, execute_js_1.executeUserSignedAction)(config, action, exports.UserPortfolioMarginTypes, opts);
}
