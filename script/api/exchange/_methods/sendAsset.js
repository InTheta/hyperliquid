...
function sendAsset(config, params, opts) {
    const action = (0, mod_js_1.canonicalize)(SendAssetActionSchema, (0, _base_js_1.parse)(SendAssetActionSchema, { type: "sendAsset", ...params }));
    return (0, mod_js_2.executeUserSignedAction)(config, action, exports.SendAssetTypes, opts);
}
