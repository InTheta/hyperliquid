...
exports.PerpConciseAnnotationsRequest = void 0;
exports.perpConciseAnnotations = perpConciseAnnotations;
 ...
 */
exports.PerpConciseAnnotationsRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint/perpetuals#retrieve-concise-perp-annotations
 */
function perpConciseAnnotations(config, signal) {
    const request = (0, _base_js_1.parse)(exports.PerpConciseAnnotationsRequest, {
