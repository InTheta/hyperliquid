...
exports.SettledOutcomeRequest = void 0;
exports.settledOutcome = settledOutcome;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint/spot#retrieve-information-about-a-settled-outcome
 */
function settledOutcome(config, params, signal) {
    const request = (0, _base_js_1.parse)(exports.SettledOutcomeRequest, {
        type: "settledOutcome",
        ...params,
    });
    return config.transport.request("info", request, signal);
}
//# sourceMappingURL=settledOutcome.js.map