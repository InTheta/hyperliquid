 ...
 */
export declare const GossipPriorityAuctionStatusRequest: v.ObjectSchema<{
    /** Type of request. */
    readonly type: v.LiteralSchema<"gossipPriorityAuctionStatus", undefined>;
}, undefined>;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/priority-fees
 */
export declare function gossipPriorityAuctionStatus(config: InfoConfig, signal?: AbortSignal): Promise<GossipPriorityAuctionStatusResponse>;
//# sourceMappingURL=gossipPriorityAuctionStatus.d.ts.map