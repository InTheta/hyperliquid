 ...
 */
export declare const SettledOutcomeRequest: v.ObjectSchema<{
    /** Type of request. */
    readonly type: v.LiteralSchema<"settledOutcome", undefined>;
    /** Outcome identifier. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint/spot#retrieve-information-about-a-settled-outcome
 */
export declare function settledOutcome(config: InfoConfig, params: SettledOutcomeParameters, signal?: AbortSignal): Promise<SettledOutcomeResponse>;
//# sourceMappingURL=settledOutcome.d.ts.map