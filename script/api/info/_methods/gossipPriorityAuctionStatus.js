...
exports.GossipPriorityAuctionStatusRequest = void 0;
exports.gossipPriorityAuctionStatus = gossipPriorityAuctionStatus;
 ...
 */
exports.GossipPriorityAuctionStatusRequest = (() => {
    return v.object({
        /** Type of request. */
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/priority-fees
 */
function gossipPriorityAuctionStatus(config, signal) {
    const request = (0, _base_js_1.parse)(exports.GossipPriorityAuctionStatusRequest, {
        type: "gossipPriorityAuctionStatus",
    });
    return config.transport.request("info", request, signal);
}
//# sourceMappingURL=gossipPriorityAuctionStatus.js.map