...
const gossipPriorityAuctionStatus_js_1 = require("./_methods/gossipPriorityAuctionStatus.js");
...
const settledOutcome_js_1 = require("./_methods/settledOutcome.js");
...
class InfoClient {
    ...
    gossipPriorityAuctionStatus(signal) {
        return (0, gossipPriorityAuctionStatus_js_1.gossipPriorityAuctionStatus)(this.config_, signal);
    }
    /**
    ...
    settledOutcome(params, signal) {
        return (0, settledOutcome_js_1.settledOutcome)(this.config_, params, signal);
    }
    /**
