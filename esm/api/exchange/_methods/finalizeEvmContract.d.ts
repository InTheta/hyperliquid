 ...
 */
export declare const FinalizeEvmContractRequest: v.ObjectSchema<{
    /** Action to perform. */
    readonly action: v.ObjectSchema<{
        /** Type of action. */
        readonly type: v.LiteralSchema<"finalizeEvmContract", undefined>;
         ...
         */
        readonly input: v.UnionSchema<[v.ObjectSchema<{
            /** Use the EVM deployment nonce of an EOA-deployed contract. */
            readonly create: v.ObjectSchema<{
                /** Nonce used to deploy the EVM contract. */
                readonly nonce: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
            }, undefined>;
        }, undefined>, v.LiteralSchema<"firstStorageSlot", undefined>, v.LiteralSchema<"customStorageSlot", undefined>], undefined>;
    }, undefined>;
...
declare const FinalizeEvmContractActionSchema: v.ObjectSchema<{
    /** Type of action. */
    readonly type: v.LiteralSchema<"finalizeEvmContract", undefined>;
    /** Token identifier to link. */
    readonly token: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/hyperevm/hypercore-less-than-greater-than-hyperevm-transfers
 */
export declare function finalizeEvmContract(config: ExchangeConfig, params: FinalizeEvmContractParameters, opts?: FinalizeEvmContractOptions): Promise<FinalizeEvmContractSuccessResponse>;
export {};
//# sourceMappingURL=finalizeEvmContract.d.ts.map