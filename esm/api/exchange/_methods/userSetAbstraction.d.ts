...
export declare const UserSetAbstractionRequest: v.ObjectSchema<{
    ...
    readonly action: v.ObjectSchema<{
        ...
        readonly abstraction: v.PicklistSchema<["disabled", "unifiedAccount", "portfolioMargin"], undefined>;
...
declare const UserSetAbstractionActionSchema: Omit<v.ObjectSchema<{
    ...
    readonly "~run": (dataset: v.UnknownDataset, config: v.Config<v.BaseIssue<unknown>>) => v.OutputDataset<{
        ...
        user: `0x${string}`;
        abstraction: "disabled" | "unifiedAccount" | "portfolioMargin";
    }, v.StringIssue | v.RegexIssue<string> | v.LengthIssue<`0x${string}`, 42> | v.ObjectIssue | v.LiteralIssue | v.PicklistIssue>;
    readonly "~types"?: {
        readonly input: {
            type: "userSetAbstraction";
            user: string;
        ...
        readonly issue: v.StringIssue | v.RegexIssue<string> | v.LengthIssue<`0x${string}`, 42> | v.ObjectIssue | v.LiteralIssue | v.PicklistIssue;
    } | undefined;
};
