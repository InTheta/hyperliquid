 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint#deposit-or-withdraw-from-an-hip-3-dexs-backstop-liquidator
 */
export function hip3LiquidatorTransfer(config, params, opts) {
    const action = canonicalize(Hip3LiquidatorTransferActionSchema, parse(Hip3LiquidatorTransferActionSchema, { type: "hip3LiquidatorTransfer", ...params }));
