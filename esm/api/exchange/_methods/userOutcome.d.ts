 ...
 */
export declare const UserOutcomeRequest: v.ObjectSchema<{
    /** Outcome action. */
    readonly action: v.VariantSchema<"type", [v.ObjectSchema<{
        /** Type of action. */
        readonly type: v.LiteralSchema<"userOutcome", undefined>;
        /** Split `X` quote tokens into `X` Yes and `X` No shares of an outcome. */
        readonly splitOutcome: v.ObjectSchema<{
            /** Outcome identifier. */
            readonly outcome: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
        ...
        readonly mergeOutcome: v.ObjectSchema<{
            /** Outcome identifier. */
            readonly outcome: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
        ...
        readonly mergeQuestion: v.ObjectSchema<{
            /** Question identifier. */
            readonly question: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
            /** Amount of shares to merge, or `null` for the maximum available. */
            readonly amount: v.NullableSchema<v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToStringAction<string | number, undefined>, v.StringSchema<undefined>, v.TransformAction<string, string>, v.RegexAction<string, undefined>]>, undefined>;
        }, undefined>;
    }, undefined>, v.ObjectSchema<{
         ...
         */
        readonly negateOutcome: v.ObjectSchema<{
            /** Question identifier. */
            readonly question: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
            /** Outcome identifier. */
            readonly outcome: v.SchemaWithPipe<readonly [v.UnionSchema<[v.StringSchema<undefined>, v.NumberSchema<undefined>], undefined>, v.ToNumberAction<string | number, undefined>, v.NumberSchema<undefined>, v.SafeIntegerAction<number, undefined>, v.MinValueAction<number, 0, undefined>]>;
...
declare const UserOutcomeActionSchema: v.VariantSchema<"type", [v.ObjectSchema<{
    /** Type of action. */
    readonly type: v.LiteralSchema<"userOutcome", undefined>;
    /** Split `X` quote tokens into `X` Yes and `X` No shares of an outcome. */
    readonly splitOutcome: v.ObjectSchema<{
...
export type UserOutcomeParameters = v.InferInput<typeof UserOutcomeActionSchema> extends infer T ? T extends unknown ? {
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint#negate-outcome
 */
export declare function userOutcome(config: ExchangeConfig, params: UserOutcomeParameters, opts?: UserOutcomeOptions): Promise<UserOutcomeSuccessResponse>;
export {};
//# sourceMappingURL=userOutcome.d.ts.map