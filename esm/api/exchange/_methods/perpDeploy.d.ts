    ...
    readonly action: v.VariantSchema<"type", [v.ObjectSchema<{
        ...
        readonly registerAsset2: v.ObjectSchema<{
            ...
            readonly assetRequest: v.ObjectSchema<{
                ...
                readonly marginMode: v.PicklistSchema<["strictIsolated", "noCross", "normal"], undefined>;
            }, undefined>;
            /** DEX name. */
        ...
        readonly insertMarginTable: v.ObjectSchema<{
            /** DEX name. */
            readonly dex: v.StringSchema<undefined>;
            /** Margin table to insert. */
            readonly marginTable: v.ObjectSchema<{
        ...
        readonly disableDex: v.StringSchema<undefined>;
    }, undefined>], undefined>;
