...
import { HyperliquidError, parse } from "../../../../_base.js";
import { getWalletChainId, signL1Action, signMultiSigL1, signMultiSigUserSigned, signUserSignedAction, } from "../../../../signing/mod.js";
import { Address, Hex, UnsignedInteger } from "../../../_schemas.js";
import { executeWithShell } from "./_shell.js";
// ============================================================
// Execute L1 Action
// ============================================================
/**
 ...
 * @throws {ApiRequestError} If the API returns an error response.
 */
export function executeUserSignedAction(config, action, types, options) {
    return executeWithShell(config, async (nonce) => {
