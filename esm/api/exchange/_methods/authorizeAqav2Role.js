 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint#authorize-aqav2-role
 */
export function authorizeAqav2Role(config, params, opts) {
    const action = canonicalize(AuthorizeAqav2RoleActionSchema, parse(AuthorizeAqav2RoleActionSchema, { type: "authorizeAqav2Role", ...params }));
