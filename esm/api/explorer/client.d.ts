 ...
 */
export declare class ExplorerClient<T extends IRequestTransport<"explorer"> | ISubscriptionTransport = IRequestTransport<"explorer"> & ISubscriptionTransport> {
     ...
     * @see null
     */
    blockDetails(this: ExplorerClient<IRequestTransport<"explorer">>, params: BlockDetailsParameters, signal?: AbortSignal): Promise<BlockDetailsResponse>;
    /**
     ...
     */
    explorerBlock(this: ExplorerClient<ISubscriptionTransport>, listener: (data: ExplorerBlockEvent) => void, onError?: (error: TransportError) => void): Promise<ISubscription>;
    /**
     ...
     * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
     */
    explorerTxs(this: ExplorerClient<ISubscriptionTransport>, listener: (data: ExplorerTxsEvent) => void, onError?: (error: TransportError) => void): Promise<ISubscription>;
    /**
     ...
     * @see null
     */
    txDetails(this: ExplorerClient<IRequestTransport<"explorer">>, params: TxDetailsParameters, signal?: AbortSignal): Promise<TxDetailsResponse>;
    /**
     ...
     * @see null
     */
    userDetails(this: ExplorerClient<IRequestTransport<"explorer">>, params: UserDetailsParameters, signal?: AbortSignal): Promise<UserDetailsResponse>;
}
...
export type { ExplorerBlockEvent } from "./_methods/explorerBlock.js";
export type { ExplorerTxsEvent } from "./_methods/explorerTxs.js";
